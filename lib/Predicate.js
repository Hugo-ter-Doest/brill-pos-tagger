...
var predicates = {
    // Predicates used in the English rules
    ...
    // Predicates used in the Dutch rules
    "PREVTAG": prev_tag_is,
    "NEXT1OR2TAG": next_1_or_2_tag_is, // implement x
    "NEXTTAG": next_tag_is,
    "PREV1OR2TAG": prev_1_or_2_tag,
    "WDAND2TAGAFT": current_word_and_2_tag_after, // implement x
    "NEXT1OR2OR3TAG": next_1_or_2_or_3_tag, // implement x
    "CURWD": current_word_is, // implement x
    "SURROUNDTAG": surrounded_by_tags, //implement x
    "PREV1OR2OR3TAG": prev_1_or_2_or_3_tag, 
    "WDNEXTTAG": current_word_and_next_tag_are, // implement x
    "PREV1OR2WD": prev_1_or_2_word_is, // implement x
    "NEXTWD": next_word_is, // implement x
    "PREVWD": prev_word_is,
    "NEXT2TAG": next_2_tag_is, //implement
    "WDAND2TAGBFR": current_word_and_2_tags_before_are, // implement
    "WDAND2AFT": current_word_and_2_after, // implement
    "WDPREVTAG": current_word_and_prev_tag_are, // implement; tag is first parameter
    "RBIGRAM": right_bigram_is, // implement
    "LBIGRAM": left_bigram_is, // implement
    "NEXTBIGRAM": next_bigram_is, // implement
    "PREVBIGRAM": prev_bigram_is, // implement
 };
...
function current_word_and_2_tag_after(tagged_sentence, i, parameter1, parameter2) {
