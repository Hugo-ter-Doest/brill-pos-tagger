module.exports=TransformationRules = (function() {
  /*
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c3 = function(c1, c2, pred, par) {
          // Construct rule
          var result = new TransformationRule(c1, c2, pred, par);
          return(result);
        },
        peg$c4 = /^[a-zA-Z_0-9_\-]/,
        peg$c5 = { type: "class", value: "[a-zA-Z_0-9_\\-]", description: "[a-zA-Z_0-9_\\-]" },
    ...
    function peg$parsetransformation_rule() {
      ...
      if (s1 !== peg$FAILED) {
        ...
        if (s2 !== peg$FAILED) {
          ...
          if (s3 !== peg$FAILED) {
            s4 = peg$parseS_no_eol();
            if (s4 !== peg$FAILED) {
              s5 = peg$parseidentifier();
              if (s5 !== peg$FAILED) {
                s6 = peg$parseS_no_eol();
                if (s6 !== peg$FAILED) {
